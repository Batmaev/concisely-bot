...
5. Для списков, если они нужны, используй символы-буллеты (• или -) и обычный перенос строки.
...
export function describeVideoNote(base64Video: string): Promise<DescribeResult> {
  return callMultimodal(VIDEO_MODEL, 'Что происходит / какие слова говорятся в видеосообщении?',
